...
## ✍🏻 프로젝트 개요
- 응급실 병상이 없어서 환자가 떠돌다가 숨지는 ‘응급실 뺑뺑이’ 현상에 대한 뉴스를 접하며, 평소 병상 현황을 쉽게 확인할 수 없는 점이 불
편하다고 느꼈습니다.
...
또한, Kakao Local API를 활용한 검색 기능을 제공합니다.
...
국립중앙의료원 API를 활용해 실시간 응급실 잔여 병상 수를 제공합니다. (1분 간격 갱신) <br>
또한, Kakao Mobility API를 활용해 이동 거리와 예상 이동 소요 시간을 제공합니다.
...
응급실 상세보기에서 버튼을 클릭해 Kakao Map 길찾기 기능을 사용할 수 있습니다.
...
<table>
  ...
  <tr>
    ...
    <td align="center" width="50%">Spring API Server 개발 (Java)</td>
  </tr>
</table>
...
제가 담당한 기능 (문진표 CRUD, 문진표 공유, 응급실 실시간 잔여 병상 수 갱신, AWS EC2 및 데이터베이스 구축 등)을 포함하여 <br>
다른 팀원이 담당한 기능 (로그인, 응급실 정보 저장, Kakao Mobility API 활용 등)을 모두 포함합니다.
